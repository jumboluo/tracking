...
Ext.onReady(function(){
    ...
    if(Ext.form && Ext.form.field && Ext.form.field.Base){
    ...
    if(Ext.picker && Ext.picker.Month) {
    ...
    if(Ext.form && Ext.form.field && Ext.form.field.Text){
    ...
    if(Ext.form && Ext.form.field && Ext.form.field.Number){
    ...
    if(Ext.form && Ext.form.field && Ext.form.field.Date){
    ...
    if(Ext.form && Ext.form.field && Ext.form.field.VTypes){
    ...
    if(Ext.form && Ext.form.field && Ext.form.field.HtmlEditor){
    ...
    if(Ext.grid && Ext.grid.PropertyColumnModel){
