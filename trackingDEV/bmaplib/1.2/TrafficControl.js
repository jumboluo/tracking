...
//            "id": "tcBtn",
    ...
    TrafficControl.prototype._popUpDiv = function (me, btn) {
        ...
        var guid = this.guid = this._map.guid;

        //将弹出div的HTML插入到dom中
        insertHTML(btn, "afterEnd", genHtml());

        //将用到的dom元素都存到变量中
        var viewPreDom = baidu.g("tcViewPrediction-" + guid);
        var dvPredition = baidu.g("tcPredition-" + guid);
        var dvTcTitle = baidu.g("tcTitle-" + guid);
        var dvTcDay = baidu.g("maplibTcDay-" + guid);
        var dvTcNow = baidu.g("tcNow-" + guid);
        var dvTcWrap = baidu.g("tcWrap-" + guid);
        var dvTcTimeBox = baidu.g("tcTimeBox-" + guid);
        var dvTcUpdate = baidu.g("tcUpdate-" + guid);
        ...
        this.hide = function () {
            ...
            baidu.dom.addClass("tcWrap-" + guid, "maplibTcHide");
            baidu.dom.addClass("tcPredition-" + guid, "maplibTcHide");
            me.hideTraffic();
        }
        /**
         * 返回该控制面板的状态             *
        ...
        baidu.event.on("tcClose-" +  guid, "click", function (e) {
           	showOrHidePopDiv();
        })
        ...
        function initialize() {
            ...
            bRealTime = true;
            baidu.dom.removeClass("tcWrap-" + guid, "maplibTcHide");

			//初始化a的状态
     		var arrA = baidu.g("tcWeek-" + guid).getElementsByTagName("a");
            for (var i = 0; i < 7; i++) {
                arrA[i].className = '';
            }
        ...
        //生成弹出div中的html
        function genHtml() {
            var html = ['<div class="maplibTc maplibTcHide" id="tcWrap-' + guid + '">'];
            html.push('<div class="maplibTcColor" id="tcTitle-' + guid + '">实时路况</div>');
            html.push('<div>'); //删除  id="tcRealTime-' + guid + '"
            html.push('<div class="maplibTcTime"><span id="maplibTcDay-' + guid + '" class="maplibTcCurTime">更新时间</span><span><span class="maplibTcColon">：&nbsp;</span><span class="maplibTcCurTime" id="tcNow-' + guid + '"></span><span title="更新" id="tcUpdate-' + guid + '" class="maplibTcUpdate"></span> <a href="javascript:void(0)" class="maplibTcView" id="tcViewPrediction-' + guid + '">查看流量预测</a><button class="maplibTcClose" id="tcClose-' + guid + '"></button></div></div>');
            html.push('<div id="tcPredition-' + guid + '" class="maplibTcHide">');
            html.push('<div class="maplibTcWeekDay"><span>星期</span><ul id="tcWeek-' + guid + '"><li><a lang="1" href="javascript:void(0)">一</a></li><li><a lang="2" href="javascript:void(0)">二</a></li><li><a lang="3" href="javascript:void(0)">三</a></li><li><a lang="4" href="javascript:void(0)">四</a></li><li><a lang="5" href="javascript:void(0)">五</a></li><li><a lang="6" href="javascript:void(0)">六</a></li><li><a lang="7" href="javascript:void(0)">日</a></li></ul></div>');
            html.push('<div><div class="maplibTcRuleTxt">时间</div>');
            html.push('<div class="maplibTcRule">');
            html.push('<div><div class="maplibTcTimeBox" id="tcTimeBox-' + guid + '">20:00</div></div>');
            html.push('<div class="maplibTcTimeline" >');
            html.push('<div class="maplibTcTimelinePrev" id="tcPrev-' + guid + '"></div>');
            html.push('<div class="maplibTcTimeMove" id="tcMove-' + guid + '"></div>');
            html.push('<div class="maplibTcTimelineNext" id="tcNext-' + guid + '"></div>');
        ...
        function bindEventToPopDiv(me) {
            ...
            baidu.event.on("tcViewPrediction-" + guid , "click", function () {
            ...
            baidu.event.on("tcUpdate-" + guid, "click", function () {
                initialize();
            });
        }
        ...
        function bindEventToWeek(me) {
            baidu.event.on("tcWeek-" + guid, "onclick", function (e) {
        ...
        function setBar(me) {
            ...
            function dragIng(e) {
                var x = e.clientX || e.x;
                var left = getPosition(baidu.G("tcPrev-"+guid)).left + 9;
                var margin = x - left - 4;
            ...
            //绑定时间条中向前的箭头
            baidu.on("tcPrev-" + guid, "click", function () {
                setBarBtn("prev");

            });
            //绑定时间条中向后的箭头
            baidu.on("tcNext-" + guid, "click", function () {
                setBarBtn("next");
            });
            ...
            function setBarBtn(key) {
                var box = dvTcTimeBox;
                var margin = parseInt(baidu.dom.getStyle("tcTimeBox-" + guid, "marginLeft"));
    ...
    TrafficControl.prototype.remove = function(){
        this.hideTraffic();
        var dvWrap = baidu.g("tcWrap-"+this.guid);
        //移除在dom中添加的html
        if(dvWrap) dvWrap.parentNode.removeChild(dvWrap);
